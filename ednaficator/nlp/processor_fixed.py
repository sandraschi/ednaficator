...
class Intent:
    ...
    workflow: str | None = None  # predefined workflow name
...
class NLPProcessor:
    ...
    def _load_intent_patterns(self) -> dict[str, list[str]]:
        ...
        return {
            ...
            "morning_workflow": [r"guten.*morgen", r"morning.*routine", r"morgen.*ablauf"],
        }
    ...
    async def _llm_parse_intent(self, text: str) -> Intent:
        ...
        fallback_intent.confidence = max(
            0.1, fallback_intent.confidence - 0.1
    ...
    async def generate_response_text(self, intent: Intent, results: list[dict] = None) -> str:
        ...
        if intent.category == "error":
            return (
                "Entschuldigung, da ist etwas schiefgelaufen. Bitte versuche es später noch einmal."
            )
