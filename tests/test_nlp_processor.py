...
from ednaficator.nlp.processor_fixed import NLPProcessor, Intent
...
async def test_pattern_matching(nlp_processor, input_text, expected_category, expected_action, min_confidence):
